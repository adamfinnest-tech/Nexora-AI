...
const SignupPage = () => {
  ...
  return (
    <div className="relative min-h-screen w-full flex overflow-hidden bg-[#FAF9FD]">
      ...
      <div className="relative z-10 w-full max-w-[1600px] mx-auto flex flex-col lg:flex-row items-center justify-between p-4 py-8 sm:p-8 lg:p-24 min-h-screen">
        ...
        <div className="flex-1 w-full text-center lg:text-left mb-8 lg:mb-0 lg:pr-12 pt-4 lg:pt-0 flex flex-col items-center lg:items-start justify-center">
          ...
          <p className="text-lg md:text-2xl text-gray-800/80 leading-relaxed font-sans max-w-lg mx-auto lg:mx-0 font-medium animate-slide-up" style={{ animationDelay: '0.2s' }}>
          ...
          <div className="relative group">
            ...
            <div className="bg-white/40 backdrop-blur-2xl border border-white/60 shadow-[0_8px_32px_0_rgba(31,38,135,0.07)] rounded-[2.5rem] p-8 md:p-10 relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <div className="flex flex-col gap-2 mb-8">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 font-medium text-sm">Get started with your Executive Assistant</p>
                    </div>
                  </div>
                </div>
                ...
                {/* Footer Links */}
                <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4 text-sm font-medium text-gray-600">
                  <div className="flex items-center gap-1.5">
                    <span>Already have an account?</span>
                    <Link to="/login" className="text-[#8C52FF] hover:text-[#A573FF] font-semibold transition-colors">
                      Sign In
                    </Link>
                  </div>
                </div>
